...
public class MySQL extends Database
{
    ...
    public MySQL(String driver, String url, String user, String password) throws ClassNotFoundException, SQLException
    {
    ...
    public int executeQuery1(String sql, String col, int from, int to, ResultSetCallback callback)
    {
        if (sql == null)
        {
            throw new NullPointerException();
