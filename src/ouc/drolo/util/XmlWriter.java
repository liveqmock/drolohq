 ...
 * 
 */
class XmlWriter implements XmlSerializer
{
        ...
        for (int i = 0; i < s.length(); i++)
        {
            ...
            switch (c)
            {
                ...
                default:
                    ...
                    // BEGIN android-changed: refuse to output invalid
                    // characters
                    // See http://www.w3.org/TR/REC-xml/#charsets for
                    // definition.
                    // No other Java XML writer we know of does this, but no
                    // Java
                    // XML reader we know of is able to parse the bad output
                    // we'd
                    // otherwise generate.
    ...
    private final String getPrefix(String namespace, boolean includeDefault, boolean create) throws IOException
    {
        ...
        {
            if (nspStack[i + 1].equals(namespace) && (includeDefault || nspStack[i].length() != 0))
            {
