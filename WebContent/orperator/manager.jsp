...
<div id="left_top" class="left_top" style="border: 1px solid #dddddd; float: left; width: 19.5%; height: 150px;">
		...
		<table class="table2">
			<tr>
				...
				<td align="center"><input type="text" size="8"
					id="questcontext" name="questcontext" />
				<td><input type="button" value="查询"
					onclick="javascript:serachByquest(1);" class="buttom"></td>
			</tr>
...
<div align="center" id="jieguo" class="jieguo" style="border:1px solid #dddddd;float: right; width:80%; height:800px;">
...
<div id="orderleft_top" class="left_top" style="border:1px solid #dddddd;float: left;width:19.5%; height:150px;">
...
<div align="center" id="orderjieguo" class="orderjieguo" style="border:1px solid #dddddd;float: right; width:80%; height:800px;">
  ...
  <form  method="post" name="dingdanorderForm" id="dingdanorderForm" >
   <table width="99%" border="0" align="center" id="dingdanorder_Id2"> 
    <tr bgcolor="#ECFAF9" height="44">
      ...
      <td width="50">用户姓名</td>
	 <td width="60">用户地址</td>
      <td width="60">物流人员号</td>
      <td width="60">状态</td>
      <td width="60">订单创建时间</td>
	  <td width="70">重新派单</td>
