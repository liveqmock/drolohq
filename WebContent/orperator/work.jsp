...
<table width="524" border="0">
  <tr>
    <td width="139" >用户姓名：</td>
    <td width="375" ><input type="text" name="username" id="username" "></td>
  </tr>
  <tr>
    <td width="139" >用户地址：</td>
    <td width="375" ><input type="text" name="address" id="address" "></td>
  </tr>
  <tr>
    <td >洗衣数量：</td>
...
<div id="left" class="left" style="border:1px solid #dddddd;float: left; width: 16%; height: 600px;">
  ...
  <div id="HaveRefuse" style=" border:1px ;width:100%; height: 300px; text-align: center;">
		...
		<div id="scrolldfang" style="overflow-y:scroll;border:1px ;width:100%; height:300px; "	> 
	      	<form>
